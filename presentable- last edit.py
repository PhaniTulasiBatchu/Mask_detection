...
model=load_model(r'C:\Users\ELCOT\Desktop\MY ICONS\july 10th\model-008.model')
...
imgg=cv2.imread(r'C:\Users\ELCOT\Downloads\images\mask-proj.jpeg')
...
for (x,y,w,h) in faces:
    ...
    cv2.rectangle(img,(470,580),(650,650),(250,250,250),-1)
    cv2.putText(img, "ppl inside=" + str(m), (480,620),cv2.FONT_HERSHEY_SIMPLEX,0.8,(0,0,0),2)
